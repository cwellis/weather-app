...
const API_KEY = '6dcd5b948d31e07a4d05dece4e8a7e15'
...
setInterval(() => {
    ...
    timeEl.innerHTML = (hoursIn12HrFormat < 10? hoursIn12HrFormat : hoursIn12HrFormat) + ':' + (minutes < 10? minutes: minutes)+ ' ' + `<span id="am-pm">${ampm}</span>`
